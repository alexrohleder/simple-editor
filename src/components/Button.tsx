    ...
    <button
      ...
      className={cx(
        ...
        "rounded font-semibold transition-colors shadow-sm box-border inline-flex items-center relative",
        {
          ...
          "text-gray-900 dark:text-gray-300 border hover:border-current":
            variant === "secondary",
          "text-red-600 border border-red-600 hover:bg-red-600 hover:text-white":
            variant === "danger",

          "bg-opacity-75 border-opacity-25 pointer-events-none": loading,

          "text-xs px-2 h-6": size === "xsmall",
          "text-sm px-3 h-8": size === "small",
          "text-md px-4 h-9": size === "normal",
        }
      )}
    >
